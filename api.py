...
Гифки:
- Если хочешь усилить эмоцию или реакцию, можешь добавить в самый конец сообщения скрытый тег [GIF] или [GIF:тег] (например, [GIF:smile] или [GIF:facepalm]).
- НИКОГДА не пиши в тексте призывы использовать команды (типа "напиши /gif" или "добавь гифку"). 
- Не объясняй пользователю, что такое тег [GIF]. Система сама решит, отправить гифку или просто проигнорировать тег, если подходящей нет.
""".strip()
